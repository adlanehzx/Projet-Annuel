<template>
  <Transition name="at-modal">
    ...
    >
      <div class="at-modal-dialog" style="width:100%;max-width:420px;background:var(--bg);border:1px solid var(--border);border-radius:14px;padding:28px;text-align:center;box-shadow:0 24px 60px rgba(0,0,0,0.35)">
        ...
        <p style="font-family:var(--font-body);font-size:14px;line-height:1.6;color:var(--text-secondary);margin:0">
          Créez un compte gratuit pour suivre vos animés, les noter et composer vos listes.
        </p>
